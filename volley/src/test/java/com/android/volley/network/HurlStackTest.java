...
public class HurlStackTest
{
    ...
    private HttpUrlConnectionStack mHurlStack;
    ...
    public void connectionForDeprecatedGetRequest() throws Exception
    {
        ...
        HttpUrlConnectionStack.setConnectionParametersForRequest(mMockConnection, request);
    ...
    public void convertHeaders()
    {
        ...
        List<Header> result = HttpUrlConnectionStack.convertHeaders(headers);
